      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <label for="pegi">PEGI(inhoud):</label>
              <input type="number" class="form-control" id="pegi" placeholder="Voer de PEGI-beoordeling in">
            </div>
            <div class="form-group">
              <label for="pegi">PEGI(leeftijd):</label>
              <input type="number" class="form-control" id="pegi" placeholder="Voer de PEGI-beoordeling in">
            </div>
            <div class="form-group">
              <label for="duration">Duur:</label>
              <input type="text" class="form-control" id="duration" placeholder="Voer de duur van de film in">
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-danger btn-block">Toevoegen</button>
          </form>
        </div>
      </div>
    </div>
