...
if(isset($_GET['hall_id']) && filter_var($_GET['hall_id'], FILTER_VALIDATE_INT)) {
    $selected_hall_id = $_GET['hall_id'];
    ...
    try {
        ...
        $mapping_query = "SELECT film_id, hall_id FROM `shows` WHERE hall_id = :hall_id";
       ...
       <a href="index.php?page=add_shows&hall_id=<?php echo $selected_hall_id; ?>" class="btn btn-sm btn-success">Add new show + </a>
        </div>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <form action="php/delete_show.php" method="post">
                                            ...
                                            <input type="hidden" name="deleteshow" value="<?php echo $show; ?>">
